...
if cfg.output.saveTracePlots
    if ~isfolder(cfg.output.tracePlotFolder)
        mkdir(cfg.output.tracePlotFolder);
    end

    saveFigureIfValid(figures.driver, fullfile( ...
        cfg.output.tracePlotFolder, ...
        'quasi_steady_driver_tube_pressure.png'));
    saveFigureIfValid(figures.data, fullfile( ...
        cfg.output.tracePlotFolder, ...
        'quasi_steady_pcb_data_traces.png'));
    saveFigureIfValid(figures.trigger, fullfile( ...
        cfg.output.tracePlotFolder, ...
...
if ~isgraphics(figureHandle, 'figure')
    warning('plotQuasiSteadyPcbTraces:InvalidFigureHandle', ...
