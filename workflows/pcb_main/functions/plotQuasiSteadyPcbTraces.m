...
figures.driver = figure( ...
    'Name', 'Quasi-Steady Driver Tube Pressure', ...
...
title(sprintf('Quasi-Steady Driver Pressure: %.4f to %.4f s', ...
...
title(sprintf('Quasi-Steady PCB Signals: %.4f to %.4f s', ...
    steadyTimeWindow(1), steadyTimeWindow(2)), ...
    'FontSize', cfg.plotting.fontSize);
legend('show', 'Location', 'best', ...
    'FontSize', cfg.plotting.fontSize);
...
figures.trigger = figure( ...
    'Name', 'Quasi-Steady Trigger Signals', ...
    'Position', cfg.plotting.figurePosition);
hold on;
grid on;
box on;
...
title(sprintf('Quasi-Steady Trigger Signals: %.4f to %.4f s', ...
    steadyTimeWindow(1), steadyTimeWindow(2)), ...
    'FontSize', cfg.plotting.fontSize);
legend('show', 'Location', 'best', ...
    'FontSize', cfg.plotting.fontSize);
